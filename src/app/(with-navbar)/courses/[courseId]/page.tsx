...
import { Award, BookOpen, Calendar, Clock, Star, Video } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-100 via-cyan-50 to-emerald-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{
            backgroundImage: `url(${IMAGES.course.CourseCardBanner})`,
          }}
        />
      </div>
        ...
        <div className="bg-gradient-to-r from-teal-600 via-cyan-600 to-emerald-600 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 py-12 text-center relative">
            ...
            <div className="relative inline-block">
              ...
              {/* Decorative Diamond */}
              <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-gradient-to-br from-amber-400 to-orange-500 rotate-45 shadow-lg"></div>
            </div>
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <Card className="bg-white/80 backdrop-blur-sm border-2 border-teal-200 shadow-xl">
                <CardContent className="p-6 text-center">
                  <div className="w-32 h-40 mx-auto mb-4 rounded-lg overflow-hidden border-4 border-teal-300">
                    <Image
            ...
            <div className="lg:col-span-2">
              <div className="grid md:grid-cols-2 gap-6">
                {/* Course Info Cards */}
                <Card className="bg-white/90 backdrop-blur-sm border-2 border-cyan-200 shadow-lg hover:shadow-xl transition-shadow">
                  <CardContent className="p-6 text-center">
                ...
                <Card className="bg-white/90 backdrop-blur-sm border-2 border-emerald-200 shadow-lg hover:shadow-xl transition-shadow">
                  <CardContent className="p-6 text-center">
                ...
                <Card className="bg-gradient-to-br from-pink-50 to-rose-100 border-2 border-rose-200 shadow-lg hover:shadow-xl transition-shadow">
                  <CardContent className="p-6 text-center">
                ...
                <Card className="bg-white/90 backdrop-blur-sm border-2 border-blue-200 shadow-lg hover:shadow-xl transition-shadow">
                  <CardContent className="p-6 text-center">
                ...
                <Card className="bg-white/90 backdrop-blur-sm border-2 border-purple-200 shadow-lg hover:shadow-xl transition-shadow">
                  <CardContent className="p-6 text-center">
                ...
                <Card className="bg-gradient-to-br from-green-50 to-emerald-100 border-2 border-emerald-200 shadow-lg hover:shadow-xl transition-shadow">
                  <CardContent className="p-6 text-center">
              ...
              <Card className="bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-2xl sticky top-6">
                ...
                <CardContent className="space-y-6">
                  <Link href={`/quran-lc-basic/registration`} className="block">
                    <Button className="w-full">এখনই রেজিস্ট্রেশন করুন</Button>
                  </Link>
